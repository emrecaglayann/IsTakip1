...
namespace IsTakip.Data.Migrations
{
    ...
    [Migration("20230419094231_1001_Ilk")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IsTakip.Core.Entites.Kullanici", b =>
                {
                    ...
                    b.Property<int?>("IsDosyaId")
                        .HasColumnType("int");

                    b.Property<int?>("IsId")
                        .HasColumnType("int");

                    b.Property<int?>("KalinlikIdId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsDosyaId");

                    b.HasIndex("IsId");

                    b.HasIndex("KalinlikIdId");
            ...
            modelBuilder.Entity("KullaniciMailParametreleri", b =>
                {
                    b.Property<int>("KullaniciId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("KullaniciId", "MailParametreleriId");

                    b.HasIndex("MailParametreleriId");

                    b.ToTable("KullaniciMailParametreleri");
                });
            ...
            modelBuilder.Entity("IsTakip.Core.Entites.Kullanici", b =>
                {
                    b.HasOne("IsTakip.Core.Entites.Ajanda", null)
                        .WithMany("Kullanici")
                    ...
                    b.HasOne("IsTakip.Core.Entites.DurusTip", null)
                        .WithMany("Kullanici")
                        .HasForeignKey("DurusTipId");

                    b.HasOne("IsTakip.Core.Entites.IsDosya", null)
                        .WithMany("Kullanici")
                        .HasForeignKey("IsDosyaId");

                    b.HasOne("IsTakip.Core.Entites.Is", null)
                        .WithMany("Kullanici")
                        .HasForeignKey("IsId");

                    b.HasOne("IsTakip.Core.Entites.KalinlikId", null)
                        .WithMany("Kullanici")
                        .HasForeignKey("KalinlikIdId");

                    b.HasOne("IsTakip.Core.Entites.Kullanici", null)
                        .WithMany("Kullanici")
                    ...
                    b.HasOne("IsTakip.Core.Entites.MusteriSinif", null)
                        .WithMany("Kullanici")
                    ...
                    b.HasOne("IsTakip.Core.Entites.UretimDurus", null)
                        .WithMany("Kullanici")
                        .HasForeignKey("UretimDurusId");
